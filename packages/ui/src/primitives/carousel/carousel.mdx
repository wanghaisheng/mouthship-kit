...
export const apiExampleCode = `import { type CarouselApi } from "@mouthshipkit/ui/carousel"
...
import { type CarouselApi } from "@mouthshipkit/ui/carousel";
